        ...
        <>
            <footer className="bg-white">
                <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
                        ...
                        <div className="flex justify-between gap-12">
                            <div>                                
                                <ul className="mt-6 space-y-4 text-sm">
                                    <li>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75"> Serivces </a>
                                    </li>
                            ...
                            <div>                                
                                <ul className="mt-6 space-y-4 text-sm">
                                    <li>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75"> Customer Service</a>
                                    </li>
                    ...
                    <p className="text-xs text-gray-500">&copy; { new Date().getFullYear() }. Bokamoso. All rights reserved.</p>
                </div>
            </footer>
        </>
    )
